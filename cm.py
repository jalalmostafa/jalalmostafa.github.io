...
parser = argparse.ArgumentParser(description='Create posts and pages for Jekyll blogs')
...
parser_post.add_argument('--categories', action='store', help='Post Categories')

parser_page = subparsers.add_parser('page')
parser_page.set_defaults(func=create_page)
parser_page.add_argument('name')
parser_page.add_argument('--layout', action='store', required=True, help='Page Layout')
parser_page.add_argument('--permalink', action='store', help='Page Permalink')
parser_page.add_argument('--fields', action='store', help='Additional fields to page header e.g. order 1 publish false')
